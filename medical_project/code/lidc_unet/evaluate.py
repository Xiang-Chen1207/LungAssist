...
def evaluate(model_path: str,
    ...
    test_dataset = LIDCDataset(test_dir, augment=False, preprocess_method=preprocess_method)
...
def evaluate_multiple_thresholds(model_path: str, test_dir: str,
    ...
    # 加载数据
    test_dataset = LIDCDataset(test_dir, preprocess_method=preprocess_method)
    test_loader = torch.utils.data.DataLoader(
